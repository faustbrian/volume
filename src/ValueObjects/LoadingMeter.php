...
final readonly class LoadingMeter implements Stringable
{
     ...
     * @throws InvalidQuantityException        When quantity is less than 1
     * @throws InvalidStackingFactorException  When stacking factor is not positive
     * @throws InvalidTruckWidthException      When truck width is not positive
     */
    public static function fromCentimeters(
        ...
        throw_if($quantity < 1, InvalidQuantityException::mustBeAtLeastOne());
        throw_if($stackingFactor <= 0, InvalidStackingFactorException::mustBePositive());
        throw_if($truckWidth <= 0, InvalidTruckWidthException::mustBePositive());
