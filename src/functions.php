 ...
 *                                                      Must be a positive number in the unit specified by $unit.
 *
 * @throws InvalidDimensionsException When dimensions array doesn't contain exactly 3 values
 * @throws InvalidDimensionsException When required dimension parameters (length, width, height) are missing
 * @throws InvalidDimensionsException When dimensions array contains invalid or missing keys
 * @throws InvalidDimensionsException When any dimension value is zero or negative
 *
...
function volume(
    ...
    if ($length === null || $width === null || $height === null) {
        ...
        throw InvalidDimensionsException::missingRequired($missing);
    }
